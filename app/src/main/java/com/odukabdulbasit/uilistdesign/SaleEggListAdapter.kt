...
class SaleEggListAdapter(val eggList: MutableList<SaleEggModel>) : RecyclerView.Adapter<SaleEggListAdapter.ModelViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ModelViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.sale_list_item, parent, false)
